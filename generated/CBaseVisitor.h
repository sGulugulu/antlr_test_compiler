...
public:
  ...
  virtual antlrcpp::Any visitVcSpecificModifer(CParser::VcSpecificModiferContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitIfSelection(CParser::IfSelectionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitSwitchSelection(CParser::SwitchSelectionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitForIterationStatement(CParser::ForIterationStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitWhileIterationStatement(CParser::WhileIterationStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitDoWhileIterationStatement(CParser::DoWhileIterationStatementContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitForBeforeExpression(CParser::ForBeforeExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitForAfterExpression(CParser::ForAfterExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitForMidExpression(CParser::ForMidExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitBreakpointStatement(CParser::BreakpointStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitBreakpointArg(CParser::BreakpointArgContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitContinueStatement(CParser::ContinueStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitBreakStatement(CParser::BreakStatementContext *ctx) override {
    return visitChildren(ctx);
  }
